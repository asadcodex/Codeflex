...
export default function VoiceAIPage() {
  ...
  const spawnSpark = (container: HTMLElement) => {
    ...
    spark.className = 'absolute bg-yellow-300 rounded-full pointer-events-none z-0';
    spark.style.width = '12px';
    spark.style.height = '12px';
    spark.style.left = 'calc(50% - 6px)';
    spark.style.top = 'calc(50% - 6px)';
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-12 text-center">
      <h1 className="text-4xl font-bold mb-2 text-black">Voice AI <span className="italic font-normal">Constellation</span></h1>
      <p className="text-gray-600 max-w-2xl mx-auto mb-12">
        Hunt for voice AI treasures across the digital cosmos! Uncover powerful tools, test amazing technologies, and
        collect your favorite <em>(speech to speech)</em> voice-powered solutions in this stellar treasure trove.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {aiTools.map((tool, i) => (
          ...
          >
            ...
            <p className="mb-3 text-sm font-semibold text-gray-500">Powered By <span className="text-black">{tool.name}</span></p>
            <button
